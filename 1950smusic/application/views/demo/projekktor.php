...
$(document).ready(function() {
    var player = projekktor('#player_a', {
		...
		//continuous: true,
		//loop: true
                playerFlashMP4:         '/assets/plugins/projekktor-1.3.09/swf/Jarisplayer/jarisplayer.swf',
                playerFlashMP3:         '/assets/plugins/projekktor-1.3.09/swf/Jarisplayer/jarisplayer.swf',
    });
    ...
    (
    	{
    		src: '/assets/plugins/projekktor-1.3.09/media/intro.mp4',
    		type: 'video/mp4',
    	}
    );
/*
